            ...
            modelBuilder.Entity("HELMo_bilite.Models.Client", b =>
                {
                    ...
                    b.HasOne("HELMo_bilite.Models.User", null)
                        .WithOne()
                        .HasForeignKey("HELMo_bilite.Models.Client", "matricule")
            ...
            modelBuilder.Entity("HELMo_bilite.Models.Dispatcher", b =>
                {
                    b.HasOne("HELMo_bilite.Models.User", null)
                        .WithOne()
                        .HasForeignKey("HELMo_bilite.Models.Dispatcher", "matricule")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HELMo_bilite.Models.Driver", b =>
                {
                    b.HasOne("HELMo_bilite.Models.User", null)
                        .WithOne()
                        .HasForeignKey("HELMo_bilite.Models.Driver", "matricule")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
